...
}:
{
  ...
  ghostty-nightly = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-VWAbqltm02oRK4B7qF1b6X5wMYZ5c0casJPHCisP4S0=";
    };
  };
  helium-linux = {
    pname = "helium-linux";
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "sha256-L0yK+S+IZ7Nv3lCcWcEXombBjenYNAj1QpwD+bIST6I=";
    };
  };
  helium-macos = {
    pname = "helium-macos";
  ...
  zen = {
    ...
    version = "1.22.1b";
    src = fetchurl {
      url = "https://github.com/zen-browser/desktop/releases/download/1.22.1b/zen.macos-universal.dmg";
      sha256 = "sha256-OQSmejhRsaYZ4tP6enCDWh1+Q2etMJMcz5tNIykq+ZA=";
    };
  };
  zen-twilight = {
    pname = "zen-twilight";
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-6zJApcsDvWDk12efQc4BgWaV7GCKljJ54yleddWhsOQ=";
    };
  };
}
