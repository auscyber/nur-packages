...
}:
{
  ...
  ghostty-nightly = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-G7peuXeri72LpjSGMUoPj/Y8xRRfjh+CbQLXS2+DJf4=";
    };
  };
  helium-linux = {
    pname = "helium-linux";
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "sha256-4oWehlqTMkkLO9ncA6xvg31Y1IfVz6ENv8M2rG7BUi4=";
    };
  };
  helium-macos = {
    pname = "helium-macos";
    version = "0.14.8.1";
    src = fetchurl {
      url = "https://github.com/imputnet/helium-macos/releases/download/0.14.8.1/helium_0.14.8.1_arm64-macos.dmg";
      sha256 = "sha256-4Mh/8S3Ou0axqPE7d9Lia13xOyhSdnjzUXDzhAl1G8M=";
    };
  };
  kanata = {
    pname = "kanata";
  ...
  karabiner-dk = {
    ...
    version = "8.2.0";
    src = fetchurl {
      url = "https://github.com/pqrs-org/Karabiner-DriverKit-VirtualHIDDevice/archive/v8.2.0.tar.gz";
      sha256 = "sha256-32qFxK3uCC5Owi8raBC98DeNUg1+2WOp1m6+NKRzD8o=";
    };
  };
  yabai = {
    pname = "yabai";
  ...
  zen-twilight = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-Td8qXfAtOY6swOr8s4rKnSDCyN1h8WLm2234xkFu3s4=";
    };
  };
}
